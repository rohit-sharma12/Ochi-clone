...
const Footer = () => {
    return (
        <div className="w-full flex gap-10 h-screen p-16">
            <div className="w-1/2 flex flex-col h-full justify-between">
                <div className="heading">
                    <h1 className="text-[8vw] uppercase font-bold leading-none -mb-6 text-zinc-800 tracking-tighter">Eye- </h1>
                    <h1 className="text-[8vw] uppercase font-bold leading-none -mb-6 text-zinc-800 tracking-tighter">Opening</h1>
                </div>
            ...
            <div className="w-1/2">
                <h1 className="text-[7vw] uppercase font-bold leading-none -mb-6 text-zinc-800 tracking-tighter">presentation</h1>
                <div className="mt-10 underline flex flex-row gap-10">
                    {["Intagram", "Facebook", "Linkedin", "Behance"].map((item, index) => (
                        <a className="block text-xl font-light" key={index} href="#">{item}</a>
                    ))}
                </div>
                <div className="mt-10 underline">
                    {["Home", "Services", "Our Works", "About Us", "Insights", "Contact Is"].map((item, index) => (
                        <a className="block text-xl font-light" key={index} href="#">{item}</a>
                    ))}
                </div>
            </div>
